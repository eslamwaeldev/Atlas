    ...
    <>
      ...
      >
        ...
        <div className="flex flex-col justify-center items-center gap-8 subpixel-antialiased text-center leading-atlas-heading-sm pt-10 h-full">
          <h1 className={`font-heading font-semibold text-5xl leading-atlas-heading  antialiased`}>
            Welcome to Atlas
          </h1>
          <p className="2xl:text-2xl text-xl font-medium w-1/2 2xl:w-2/5 font-sans">
          ...
          <p className="antialiased w-3/5 2xl:w-5/12 2xl:text-xl text-lg font-medium font-sans">
